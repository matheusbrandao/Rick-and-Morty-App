...
import com.matheusbrandao.rickandmorty.ui.MainActivity
...
fun BottomNavigationView.setupWithNavController(
        ...
        containerId: Int,
        intent: Intent,
        itemSelectedListener: MainActivity.OnNavigationItemSelectedListener
    ...
    setOnNavigationItemSelectedListener { item ->
        ...
        if (fragmentManager.isStateSaved) {
            ...
            if (selectedItemTag != newlySelectedItemTag) {
                // Pop everything above the first fragment (the "fixed findDownloads destination")
